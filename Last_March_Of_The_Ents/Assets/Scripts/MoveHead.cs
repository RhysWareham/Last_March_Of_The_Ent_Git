...
public class MoveHead : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        torsoPos = torso.transform.localPosition;
    }
    ...
    public void SetupCharacter()
    {
        dead = false;
        body.gravityScale = 0;
        waistBone.GetComponent<Rigidbody2D>().velocity = Vector2.zero;
        waistBone.GetComponent<Rigidbody2D>().angularVelocity = 0;
